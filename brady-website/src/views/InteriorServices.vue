...
<template>
  ...
  <section class="py-16 md:py-24">
    <div class="container mx-auto px-4 md:px-6">
      <div class="text-center max-w-3xl mx-auto mb-16">
        <h2 class="section-title">Our Interior Design Expertise</h2>
  ...
  <section class="py-16 md:py-24">
    <div class="container mx-auto px-4 md:px-6">
      <div class="text-center max-w-3xl mx-auto mb-16">
        <h2 class="section-title">Featured Interior Projects</h2>
        <p class="text-gray-600">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
          ...
          <div class="flex items-center">
            ...
            <div>
              <h4 class="font-bold text-brady-charcoal">Jennifer Williams</h4>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
          ...
          <div class="flex items-center">
            ...
            <div>
              <h4 class="font-bold text-brady-charcoal">Michael & Sarah Johnson</h4>
              <p class="text-gray-600">Residential Clients</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        <div class="grid grid-cols-1 md:grid-cols-2">
          ...
          <div class="p-8 md:p-12">
            <h3 class="text-2xl font-bold text-brady-charcoal mb-4">Ready to Transform Your Space?</h3>
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-center space-x-4">
                <a href="#" class="text-brady-charcoal hover:text-brady-gold transition-colors">

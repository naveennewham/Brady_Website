      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div class="flex items-center gap-3">
            <!-- Facebook -->
            <a href="https://www.facebook.com/profile.php?id=61580221034200" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full flex items-center justify-center bg-brady-gray-900 border border-brady-gray-700 text-white hover:bg-brady-gold transition-colors">
            ...
            <!-- Instagram -->
            <a href="https://www.instagram.com/interiorsbrady?igsh=OGk3ejlvaWRheHp0&utm_source=qr" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full flex items-center justify-center bg-brady-gray-900 border border-brady-gray-700 text-white hover:bg-brady-gold transition-colors">
            ...
            <!-- TikTok -->
            <a href="https://www.tiktok.com/@brady.interiors?_t=ZS-90q9L3MiIcs&_r=1" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full flex items-center justify-center bg-brady-gray-900 border border-brady-gray-700 text-white hover:bg-brady-gold transition-colors">
